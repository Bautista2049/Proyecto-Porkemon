...
public static class CalculadorCaptura
{
    ...
    {
        int baseRate = porkemon.BaseData.baseRate;  float currentHP = porkemon.VidaActual;
        ...
        if (hpFactor < 0.1f) hpFactor = 0.1f; float a = baseRate * ballMultiplier * statusModifier * hpFactor;
