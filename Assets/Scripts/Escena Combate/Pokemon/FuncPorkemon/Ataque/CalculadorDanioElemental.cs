...
public class CalculadorDanioElemental : MonoBehaviour 
{
    ...
    static CalculadorDanioElemental()
    {
        ...
        tablaEfectividad[(int)TipoElemental.Acero, (int)TipoElemental.Lucha] = 0.5f;
        tablaEfectividad[(int)TipoElemental.Acero, (int)TipoElemental.Tierra] = 0.5f;
        ...
        tablaEfectividad[(int)TipoElemental.Planta, (int)TipoElemental.Dragon] = 0.5f;
        ...
        tablaEfectividad[(int)TipoElemental.Lucha, (int)TipoElemental.Acero] = 2f;
        ...
        tablaEfectividad[(int)TipoElemental.Lucha, (int)TipoElemental.Bicho] = 0.5f;
        ...
        tablaEfectividad[(int)TipoElemental.Volador, (int)TipoElemental.Acero] = 0.5f;
        ...
        tablaEfectividad[(int)TipoElemental.Bicho, (int)TipoElemental.Hada] = 0.5f;
    ...
    public static float CalcularEfectividad(TipoElemental ataqueTipo, TipoElemental defensorTipo1, TipoElemental defensorTipo2)
    {
        ...
        if (defensorTipo2 != TipoElemental.Normal)
        {
            efectividad *= tablaEfectividad[(int)ataqueTipo, (int)defensorTipo2];
        }
    ...
    public static string GetMensajeEfectividad(float efectividad)
    {
        ...
        if (efectividad < 1.0f && efectividad > 0.0f)
